...
_sign(DEFAULT, moneyed.KGS, suffix=' сом')
...
_sign(DEFAULT, moneyed.KZT, suffix=' ₸')
...
_sign(DEFAULT, moneyed.TJS, suffix=' смн.')
_sign(DEFAULT, moneyed.TMT, suffix=' m')
...
_sign(DEFAULT, moneyed.UZS, suffix=' сум')
